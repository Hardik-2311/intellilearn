    ...
    <>
      <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        <div className="mx-auto max-w-screen-md text-center mb-4 lg:mb-12">
          <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 capitalize dark:text-white">
            Search Among your <span className="text-[#009E68]">57348</span>{" "}
        ...
        <div class="flex items-center justify-center">
          ...
          <input
            ...
            class="px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-gray-200 dark:border-gray-600 dark:bg-gray-800 dark:text-white"
          />

          <button class="ml-2 px-4 py-2 bg-black text-white rounded-md focus:outline-gray-200">
            Categories
          </button>
        </div>
      </div>
            ...
            <div className="p-4">
              <div className="max-w-sm bg-white dark:bg-gray-900 shadow-lg rounded-lg overflow-hidden">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <div className="px-6">
                    <CircleRating rating={course.rating} />
                  </div>
                </div>
              </div>
            </div>
